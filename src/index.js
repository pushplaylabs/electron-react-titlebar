...
export const TitleBar = ({ children, onVisibilityChange, icon, menu, disableMinimize, disableMaximize, className, currentWindow }) => (
  <div id="electron-app-title-bar" className={`electron-app-title-bar ${className || ''}`}>
    ...
    {!!menu && <MenuBar menu={menu} onVisibilityChange={onVisibilityChange}/>}
    {children}
